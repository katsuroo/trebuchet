...
module.exports = function (config) {
    ...
    handlebars.registerHelper('referrershort', function (text, treshold) {
        treshold = (!treshold.hasOwnProperty('hash')) ? treshold : 60;
        text = handlebars.Utils.escapeExpression(text);
        referrershort = text.length > treshold ? text.substring(0, treshold) + '...' : text;
